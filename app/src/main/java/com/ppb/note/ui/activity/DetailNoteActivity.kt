...
import com.ppb.note.ui.fragment.DefaultNoteFragment
import com.ppb.note.ui.fragment.ListNoteFragment
import com.ppb.note.ui.fragment.LongNoteFragment
import com.ppb.note.ui.viewmodel.DetailViewModel
import com.ppb.note.util.Utilities.formatToDate
...
class DetailNoteActivity : AppCompatActivity(), OnClickListener, View.OnClickListener {
    ...
    private var currentColor: Int = R.color.cardBgBlue
    ...
    override fun onClick(dialog: DialogPlus?, view: View?) {
        when (view?.id) {
            ...
            R.id.btn_orange_bg -> setBackgroundColor(R.color.cardBgBlue)
        }
